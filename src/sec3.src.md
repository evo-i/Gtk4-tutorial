...
![GtkWindow и GtkWidget](../image/window_widget.png){width=9.0cm height=6.0cm}
...
![Скриншот окна](../image/screenshot_pr3.png){width=3.3cm height=3.825cm}
...
![Скриншот окна](../image/screenshot_pr4.png){width=6.3cm height=5.325cm}
